...
<body>
    <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100">
        <?php
            echo "
            <form action='aanmeldForm2.php' method='post' class='bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <a href='../src/index.php' class='text-gray-700 hover:text-gray-900'>Go back to main menu</a>";
        ?>
    </div>
</body>
